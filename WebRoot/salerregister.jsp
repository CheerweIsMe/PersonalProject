		...
		<section class="boxed-sm">
			<div class="container">
				<div class="login-wrapper">
					<div class="row">
						<h3>注册</h3>
						<form action="${pageContext.request.contextPath}/registerSaler.do" method="post">
							<div class="form-group organic-form-2">
								<label>你的名字 *</label> <input name="name" class="form-control" type="text">
							</div>
							<div class="form-group organic-form-2">
								<label>你的邮箱 *</label> <input name="email" class="form-control" type="Email">
							</div>
							<div class="form-group organic-form-2">
							...
							<div class="form-group remember-me">
								<div class="checkbox pull-left">
									<label> <input id="ckbox" type="checkbox" onclick="fun()" > 是否同意隐私政策
									</label>
								</div>
							</div>
							<div class="form-group footer-form">
								<button id="regist" class="btn btn-brand pill" type="submit"  disabled>提交</button>
							</div>
						</form>
					</div>
				</div>
