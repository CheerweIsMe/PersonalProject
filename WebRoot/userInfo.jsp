			...
			<ul>
				...
				<li><a href="#">功能</a>
					<ul>
						...
						<li><c:if test="${u != null }">
								<li><a href="check-out.jsp">查看订单</a></li>
							</c:if></li>
					</ul></li>
			</ul>
		</nav>
			...
			<div class="container">
				<div class="login-wrapper">
					<div class="row">
						<h3>修改用户信息</h3>
						<form name="form1"
							action="${pageContext.request.contextPath}/updateUser.do?name="
							method="post">
							<div class="form-group organic-form-2">

								<label>你的ID *</label> <input name="uid" class="form-control"
									type="text" value="${u.uid }" disabled="disabled">
							</div>
							...
							<div class="form-group organic-form-2">
								<label>你的邮箱 *</label><input name="email" class="form-control"
									type="Email" value="${u.email}" disabled="disabled">
							</div>
							<div class="form-group organic-form-2">
								<label>密码 *</label> <input name="password" class="form-control"
									id="password" type="Password" value="${u.password}">
							</div>
							<div class="form-group organic-form-2">
								<label>确认密码 *</label> <input class="form-control"
									name="checkpassword" onblur="checkpwd()" id="password1"
									type="Password">
							</div>
